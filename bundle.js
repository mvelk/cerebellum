...
/***/ function(module, exports, __webpack_require__) {
	...
	const HeatMap = __webpack_require__(6);
	...
	document.addEventListener("DOMContentLoaded", () => {
	  ...
	  image.addEventListener("load", function () {
	    ...
	    // console.log(heatMap);
	    var chart = d3.select("#flow").append("svg").chart("Sankey");
	    chart.draw({nodes: [{id:"a"},{id:"b"}], links: [{source:"a", target:"b"}]});
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// let m = new Model([2,3,1],[[0,1,1],[1,3,3]],[[0,0,0],[1,4,4]],"sigmoid",0.3)
	// console.log(m.modelFunction([0,0]));

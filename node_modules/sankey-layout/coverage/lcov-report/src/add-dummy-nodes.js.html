...
<html lang="en">
<head>
    <title>Code coverage report for src/add-dummy-nodes.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> add-dummy-nodes.js
    </h1>
    <div class='clearfix'>
...
function replaceEdge(G, oldEdge, dummyRanks, direction) {
  <span class="missing-if-branch" title="if path not taken" >I</span>i</span>f (dummyRanks.length === 0) <span class="cstat-no" title="statement not covered" >return;
&nbsp;

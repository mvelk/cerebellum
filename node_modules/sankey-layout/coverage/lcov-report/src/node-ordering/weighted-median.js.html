...
<html lang="en">
<head>
    <title>Code coverage report for src/node-ordering/weighted-median.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/node-ordering/</a> weighted-median.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5182×</span>
...
<span class="cline-any cline-yes">1404×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export function medianValue(positions) {
...
&nbsp;
&nbsp;
export default function sortNodes(G, order, sweepDirection=<span class="branch-0 cbranch-no" title="branch not covered" >1) </span>{
  if (sweepDirection &gt; 0) {

...
<html lang="en">
<head>
    <title>Code coverage report for src/rank-assignment/grouped-graph.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/rank-assignment/</a> grouped-graph.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Graph } from 'graphlib';
&nbsp;
&nbsp;
...
&nbsp;
  ...
  for (let set of rankSets) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (set.type === 'min') {
<span class="cstat-no" title="statement not covered" >      Smin = true;</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    }
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!Smin) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (set.nodes.length) {

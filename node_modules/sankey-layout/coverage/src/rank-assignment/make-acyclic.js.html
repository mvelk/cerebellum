...
<html lang="en">
<head>
    <title>Code coverage report for src/rank-assignment/make-acyclic.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/rank-assignment/</a> make-acyclic.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Graph, alg } from 'graphlib';
&nbsp;
&nbsp;
/**
...
&nbsp;
  G.edges().forEach(e =&gt; {
    ...
    if (rel &lt; 0) {
      const label = G</span>.edge(e) || <span class="branch-1 cbranch-no" title="branch not covered" >{};
      label.reversed = true;
      G.removeEdge(e);
...
<span class="fstat-no" title="function not covered" >function dfs(g, vs, order, cb) {</span>
<span class="cstat-no" title="statement not covered" ></span>  if (!_.isArray(vs)) {
<span class="cstat-no" title="statement not covered" >    vs = [vs];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var navigation = (g.isDirected() ? g.successors : g.neighbors).bind(g);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var visited = {};</span>
<span class="cstat-no" title="statement not covered" >  _.each(vs, <span class="fstat-no" title="function not covered" >function(v) {</span></span>
<span class="cstat-no" title="statement not covered" ></span>    if (!g.hasNode(v)) {
<span class="cstat-no" title="statement not covered" >      throw new Error("Graph does not have node: " + v);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    doDfs(g, v, order === "post", visited, navigation, cb);</span>
  });
}
&nbsp;</pre></td></tr>
</table></pre>

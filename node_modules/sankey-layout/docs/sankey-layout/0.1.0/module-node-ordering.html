...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: node-ordering</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: node-ordering</h1>
...
<article>
    ...
    <h4 class="name" id="module:node-ordering"><span class="type-signature"></span>(require("node-ordering"))<span class="signature">(G)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Graph</span>
            ...
            <td class="description last">The graph. Nodes must have a `rank` attribute.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node-ordering_index.js.html">node-ordering/index.js</a>, <a href="node-ordering_index.js.html#line18">line 18</a>
    </li></ul></dd>

...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node-ordering/index.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node-ordering/index.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/** @module node-ordering */

...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: edge-ordering</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: edge-ordering</h1>
...
<article>
    ...
    <h4 class="name" id="module:edge-ordering"><span class="type-signature"></span>(require("edge-ordering"))<span class="signature">(G)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Graph</span>
            ...
            <td class="description last">The graph. Nodes must have `x` and `y` attributes.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="edge-ordering_index.js.html">edge-ordering/index.js</a>, <a href="edge-ordering_index.js.html#line18">line 18</a>
    </li></ul></dd>
